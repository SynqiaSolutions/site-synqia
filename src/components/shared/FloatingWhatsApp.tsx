...
const DEFAULT_MESSAGE =
  "Olá! Tenho interesse em conhecer as soluções digitais da Synqia.";
...
export default function FloatingWhatsApp() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setUrl(buildWhatsAppUrl(companyData.whatsapp, message));
    }, 100);
  }, []);
  ...
  return (
    <div className="fixed bottom-6 right-4 z-110 flex flex-col items-end gap-2 sm:bottom-8 sm:right-6 md:right-8">
      ...
      {showTooltip && (
        <span
          className="animate-in fade-in-0 zoom-in-95 duration-200 rounded-lg bg-card px-3 py-2 text-sm font-medium text-foreground shadow-lg ring-1 ring-border"
          role="tooltip"
        >
